...
function Navigation() {
  ...
  return (
    <Navbar bg="light" expand="lg">
      <Container>
        <LinkContainer to="/">
            <Navbar.Brand href="#home"><img src='https://res.cloudinary.com/djtgxff6l/image/upload/v1680303904/Munchit/MunchIT_logo_qxiiug.jpg' height='30px' width='30px'/> Munch !T</Navbar.Brand>
        </LinkContainer>        
